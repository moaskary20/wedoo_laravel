...
$taskTypes = [
    1 => [ // خدمات صيانة المنازلs
        ...
        ['id' => 3, 'name' => 'صيانة الأبواب والنوافذ', 'name_en' => 'Doors and Windows Maintenance', 'category_id' => 1, 'category_name' => 'خدمات صيانة المنازل', 'description' => 'إصلاح وصيانة الأبواب والنوافذ', 'icon' => 'fas fa-door-open', 'color' => '#f3e5f5', 'price_range' => '30-150 دينار تونسي', 'duration' => '1-2 ساعة', 'difficulty' => 'easy', 'status' => 'active', 'created_at' => '2024-01-03', 'image' => 'https://via.placeholder.com/300x200/f3e5f5/000000?text=صيانة+أبواب'],
    ],
    2 => [ // خدمات التنظيف
        ['id' => 4, 'name' => 'تنظيف عام للمنزل', 'name_en' => 'General House Cleaning', 'category_id' => 2, 'category_name' => 'خدمات التنظيف', 'description' => 'تنظيف شامل للمنزل', 'icon' => 'fas fa-broom', 'color' => '#e8f5e8', 'price_range' => '40-120 دينار تونسي', 'duration' => '2-4 ساعات', 'difficulty' => 'easy', 'status' => 'active', 'created_at' => '2024-01-04', 'image' => 'https://via.placeholder.com/300x200/e8f5e8/000000?text=تنظيف+عام'],
        ['id' => 5, 'name' => 'تنظيف السجاد', 'name_en' => 'Carpet Cleaning', 'category_id' => 2, 'category_name' => 'خدمات التنظيف', 'description' => 'تنظيف وتعقيم السجاد', 'icon' => 'fas fa-rug', 'color' => '#e8f5e8', 'price_range' => '25-80 دينار تونسي', 'duration' => '1-2 ساعة', 'difficulty' => 'easy', 'status' => 'active', 'created_at' => '2024-01-05', 'image' => 'https://via.placeholder.com/300x200/e8f5e8/000000?text=تنظيف+سجاد'],
    ],
    5 => [ // خدمات طارئة (عاجلة)
