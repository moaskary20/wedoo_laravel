...
return [
    ...
    */
    ...
    'default' => env('MAIL_MAILER', env('MAIL_DRIVER', 'brevo')),
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', env('BREVO_FROM_EMAIL', 'noreply@wedoo.com')),
        'name' => env('MAIL_FROM_NAME', env('BREVO_FROM_NAME', 'WeDoo')),
    ],
