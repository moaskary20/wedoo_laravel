...
#### Admin Panel
- **الرابط:** http://localhost:8000/admin_panel/
- **المستخدم:** mo.askary@gmail.com
- **كلمة المرور:** askary20

#### API
- **Base URL:** http://localhost:8000/api/
- **Documentation:** http://localhost:8000/api/README.md
...
### الدعم التقني
- **API Documentation:** http://localhost:8000/api/README.md
- **Admin Panel Guide:** http://localhost:8000/admin_panel/README.md
