# 🚨 حل سريع: رفع ملفات التسجيل والدخول

## 📋 المشكلة:
- ✅ `https://free-styel.store/api/craftsman/count.php` - يعمل
- ❌ `https://free-styel.store/api/auth/login.php` - غير موجود
- ❌ `https://free-styel.store/api/auth/register.php` - غير موجود
