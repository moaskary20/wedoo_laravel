...
import 'js_flutter_api_service.dart';
...
class ApiService {
  ...
  static Future<Response> post(String path, {Map<String, dynamic>? data}) async {
    if (kIsWeb) {
      try {
        // محاولة JsFlutterApiService أولاً (JavaScript مباشرة)
        final result = await JsFlutterApiService.post(path, data: data);
        return Response(
          data: result,
          statusCode: 200,
        ...
        print('JsFlutterApiService failed, trying WebApiService: $e');
        try {
  ...
  static Future<Response> get(String path, {Map<String, dynamic>? queryParameters}) async {
    if (kIsWeb) {
      try {
        // محاولة JsFlutterApiService أولاً (JavaScript مباشرة)
        final result = await JsFlutterApiService.get(path, queryParameters: queryParameters);
        return Response(
          data: result,
          statusCode: 200,
          requestOptions: RequestOptions(path: path),
